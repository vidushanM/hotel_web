    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        ...
        <div class="row">
            <div class="side-bar col-lg-3">
                ...
                <!--preference -->
                <div class="left-side">
                    <h3 class="agileits-sear-head">Featured rooms by type</h3>
                    <ul>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Double</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Duplex</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Interconnecting</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Kabana</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Pent House</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Single</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Suit</a></h6>
                            </div>
                        </li>
                        <li>
                ...
                <div class="left-side">
                    <h3 class="agileits-sear-head">Featured rooms by Preciousness</h3>
                    <ul>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Private</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Exclusive</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Expensive</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Classical</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">5 Star</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">4 Star</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">3 Star</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h6 class="side-bar active"><a href="details.php">Chep</a></h6>
                            </div>
                        </li>
                        <li>
                            <div>
